...
static constexpr auto qt_meta_stringdata_ZN11TetrixBoardE = QtMocHelpers::stringData(
    "TetrixBoard",
    "levelChanged",
    "",
    "level",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11TetrixBoardE[] = {
...
Q_CONSTINIT const QMetaObject TetrixBoard::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11TetrixBoardE.offsetsAndSizes,
    qt_meta_data_ZN11TetrixBoardE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11TetrixBoardE_t,
        // Q_OBJECT / Q_GADGET
...
void TetrixBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TetrixBoard::*)(int );
            if (_q_method_type _q_method = &TetrixBoard::levelChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (TetrixBoard::*)(int );
            if (_q_method_type _q_method = &TetrixBoard::scoreChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (TetrixBoard::*)(int );
            if (_q_method_type _q_method = &TetrixBoard::linesRemovedChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *TetrixBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11TetrixBoardE.stringdata0))
